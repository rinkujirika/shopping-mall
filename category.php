...

	{
...

		{
...

			{
				...
				$sql ="UPDATE category SET  `category`='$_POST[category]', `category_type`='$_POST[categorytype]', `description`='$_POST[description]'";
                                ...
                                <div class="col-md-12 form-group">
                                    ...
                                    <?php
...

										{
											...
											if(file_exists("imgcategory/".$rsedit['img']))

											{

												echo "<img src='imgcategory/".$rsedit['img'] ."' style='height: 150px;'>";

												echo "<input type='hidden' name='imgset' id='imgset' value='1'>";
...

											{
												...
												echo "<img src='images/default-image.jpg' style='height: 150px;'>";

												echo "<input type='hidden' name='imgset' id='imgset' value='0'>";
...
<script type="application/javascript">
...

	{
		...
		else if (document.frmcategory.imge.value == "" && document.frmcategory.imgset.value == 0)
