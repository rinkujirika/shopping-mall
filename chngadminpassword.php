<?php
...

	{
...

		{
			...
			echo $sql = "UPDATE admin SET password='$_POST[newpassword]' WHERE admin_id='$_SESSION[adminid]' AND password='$_POST[oldpassword]'";
                    ...
                    <div class="info mt-4">
                        ...
                        <center>
                            ...
                            <h4>
								...
								Enter Old password, New Password, Confirm password to change password...
