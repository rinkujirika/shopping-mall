<?php
...

    {
...

		{
            ...
            echo "<script>alert('Product/Produce deleted from cart');</script>";
...

    {
        ...
        echo "<script>alert('Product/Produce added to the cart');</script>";
                        ...
                        <div class="info mt-4 ">
                            ...
                            <center>
                                ...
                                <h4>
                                    ...
                                    Update your Cart before payment...
...

                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;
                                                    ...
                                                    <input type='checkbox' name='buyingproduct[]' value='$rs[purchase_record_id]' checked>

                                                </td>

                                                <td>&nbsp;

                                                    <img src='imgsellingproduct/$rs1[product_img1]' width='75' height='100'>

                                                </td>

                                                <td>&nbsp;

                                                    $rs1[product_description]
                                                ...
                                                <td>&nbsp;
                                                    ...
                                                    <input type='text' name='productcart' value='$rs[quantity]' size='3' onkeyup='changecost(this.value,$rs[purchase_record_id],$i)' /> $rs1[quantity_type]
                                                ...
                                                <td>&nbsp;
                                                    ...
                                                    <a href='displaycart.php?delid=$rs[purchase_record_id]' onclick='return delconfirm()' class='btn btn-danger'>
